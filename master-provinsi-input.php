...
if(isset($_GET['status'])){
    if($_GET['status'] == 'failed'){
        echo "<script>alert('Gagal menambahkan data kategori buku. Silakan coba lagi.');</script>";
    }
}
			...
			<main class="app-main">
				...
				<div class="app-content-header">
					<div class="container-fluid">
						<div class="row">
							<div class="col-sm-6">
								<h3 class="mb-0">Input Kategori Buku</h3>
							</div>
							<div class="col-sm-6">
						...
						<div class="row">
							<div class="col-12">
								<div class="card">
                                    ...
                                    <form action="proses/proses-kategori.php?aksi=inputprovinsi" method="POST">
									    <div class="card-body">
											<div class="mb-3">
												<label for="nama" class="form-label">Nama Kategori</label>
												<input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan Kategori Buku" required>
											</div>
                                        </div>
