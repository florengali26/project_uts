			...
			<main class="app-main">
				...
				<div class="app-content-header">
					<div class="container-fluid">
						<div class="row">
							<div class="col-sm-6">
								<h3 class="mb-0">Aplikasi SIMABUK</h3>
							</div>
							<div class="col-sm-6">
						...
						<div class="row">
							<div class="col-12">
								<div class="card">
									...
									<div class="card-body">
										<p>Halo user! SIMABUK merupakan singkatan dari Sistem Informasi Manajemen Buku, aplikasi ini bertujuan untuk mengajarkan bagaimana merancang sebuah dashboard pengelolaan dengan konsep CRUD menggunakan bahasa pemrograman PHP. Penulisan kode menggunakan OOP (Object Oriented Programming). Silakan gunakan secara bijak dan modifikasi sesuai keperluan!</p>
										<p>Silakan pilih salah satu tombol untuk memulai!</p>
										<a href="data-input.php" class="btn btn-primary btn-lg"><i class="bi bi-clipboard-data-fill"></i> Input Data Buku</a>
										<a href="data-list.php" class="btn btn-success btn-lg"><i class="bi bi-card-list"></i> Lihat Daftar Buku</a>
